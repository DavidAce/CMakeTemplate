#include "cli.h"
#include "../03E-random-numbers-wow/rnd.h"
#include "log.h"
#include "settings.h"
#include <CLI/CLI.hpp>
#include <fmt/core.h>
int cli::parse(int argc, char *argv[]) {
    CLI::App app;
    app.description("CMT: example 08A - subsystems");
    ...
    app.add_option("--Lx"               , settings::model::Lx            , "Model x dimension");
    app.add_option("--Ly"               , settings::model::Ly            , "Model y dimension");
